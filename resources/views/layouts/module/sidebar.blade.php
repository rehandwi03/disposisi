<div class="nav-left-sidebar sidebar-dark">
    {{-- style="background-color: rgb(46, 197, 81)" --}}
    {{-- #10B055 --}}
    <div class="menu-list">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light" href="#" data-toggle="collapse" aria-expanded="false"
                            data-target="#submenu-4" aria-controls="submenu-4"><i
                                class="fab fa-fw fa-wpforms text-light"></i>
                            Kartu Kendali</a>
                        <div id="submenu-4" class="collapse submenu bg-white" style="">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('surat_masuk.index')}}">Proses
                                        Kartu Kendali</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('surat_keluar.index')}}">Pengajuan Kartu
                                        Kendali</a>
                                </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light" href="#" data-toggle="collapse" aria-expanded="false"
                            data-target="#submenu-2" aria-controls="submenu-2"><i
                                class="fa fa-fw fa-users text-light"></i>
                            Manajemen User</a>
                    ...
                    <li class="nav-item ">
                        <a class="nav-link text-light" href="#" data-toggle="collapse" aria-expanded="false"
                            data-target="#submenu-3" aria-controls="submenu-3"><i
                                class="fa fa-fw fa-file-archive text-light"></i>
                            Manajemen Surat</a>
                        <div id="submenu-3" class="collapse submenu bg-white" style="">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('jenis_surat.index')}}">Jenis Surat</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('klasifikasi_dokumen.index')}}">Klasifikasi
                                        Dokumen</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('lokasi_kartu.index')}}">Lokasi Kartu</a>
                                </li>
                            </ul>
                        </div>
                    </li>
